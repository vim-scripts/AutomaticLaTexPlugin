...
" {{{2 --------------- s:generatelabels
function! atplib#s:generatelabels(filename)
    let s:labels={}
...
" }}}2
" {{{2 --------------- s:showlabels
" The argument is the dictionary generated by atplib#s:generatelabels.
function! atplib#s:showlabels(labels)
    " the argument a:labels=t:labels[bufname("")] !
    let l:cline=line(".")
    let l:lines=sort(keys(a:labels),"atplib#s:comparelist")
...
" under g:texmf.
function! atplib#s:Read_Input_File(ifile,check_texmf)
...
" }}}1
"{{{1 s:comparelist
function! atplib#s:comparelist(i1, i2)
...
function! atplib#s:searchbib(pattern) 
...
" This pattern matches all entry lines: author = \| title = \| ... 
	...
	for l:path in g:atp_bibinputs 
	    ...
	    " survive)
	    let s:bibdict[l:f]=readfile(fnameescape(findfile(atplib#s:append(l:f,'.bib'),atplib#s:append(l:path,"/") . "**")))
	endfor
...
" 				    let l:pos=atplib#s:count(l:lline,"{")
" 				    let l:neg=atplib#s:count(l:lline,"}")
" 				    let l:m=l:pos-l:neg
" 				    let l:pos=atplib#s:count(l:lline,"(")
" 				    let l:neg=atplib#s:count(l:lline,")")
" 				    let l:n=l:pos-l:neg
" 				    let l:o=atplib#s:count(l:lline,"\"")
...
" 					    let l:pos=atplib#s:count(get(l:bibdict[l:bibfile],l:nr+l:y),"{")
" 					    let l:neg=atplib#s:count(get(l:bibdict[l:bibfile],l:nr+l:y),"}")
" 					    let l:m+=l:pos-l:neg
" 					    let l:pos=atplib#s:count(get(l:bibdict[l:bibfile],l:nr+l:y),"(")
" 					    let l:neg=atplib#s:count(get(l:bibdict[l:bibfile],l:nr+l:y),")")
" 					    let l:n+=l:pos-l:neg
" 					    let l:o+=atplib#s:count(get(l:bibdict[l:bibfile],l:nr+l:y),"\"")
...
" 	    let l:bfieldline=l:time
	    ...
	    let l:nr=l:linenr-1
	    let l:i=atplib#s:count(get(l:bibdict[l:bibfile],l:linenr-1),"{")-atplib#s:count(get(l:bibdict[l:bibfile],l:linenr-1),"}")
	    let l:j=atplib#s:count(get(l:bibdict[l:bibfile],l:linenr-1),"(")-atplib#s:count(get(l:bibdict[l:bibfile],l:linenr-1),")") 
	    let s:lbibd={}
...
" will close. In each line we count brackets.	    
		...
		let l:pos=atplib#s:count(get(l:bibdict[l:bibfile],l:tlnr-1),"{")
		let l:neg=atplib#s:count(get(l:bibdict[l:bibfile],l:tlnr-1),"}")
		let l:i+=l:pos-l:neg
		let l:pos=atplib#s:count(get(l:bibdict[l:bibfile],l:tlnr-1),"(")
		let l:neg=atplib#s:count(get(l:bibdict[l:bibfile],l:tlnr-1),")")
		let l:j+=l:pos-l:neg
...
" 				    \ get(l:bibdict[l:bibfile],l:tlnr) !~ l:pattern_b
    ...
    " this checks if bracets {}, and () and "" appear in pairs in the current line:  
			    if l:m>0 || l:n>0 || l:o>l:o/2*2 
				while l:m>0 || l:n>0 || l:o>l:o/2*2 
				    let l:pos=atplib#s:count(get(l:bibdict[l:bibfile],l:tlnr+l:y),"{")
				    let l:neg=atplib#s:count(get(l:bibdict[l:bibfile],l:tlnr+l:y),"}")
				    let l:m+=l:pos-l:neg
				    let l:pos=atplib#s:count(get(l:bibdict[l:bibfile],l:tlnr+l:y),"(")
				    let l:neg=atplib#s:count(get(l:bibdict[l:bibfile],l:tlnr+l:y),")")
				    let l:n+=l:pos-l:neg
				    let l:o+=atplib#s:count(get(l:bibdict[l:bibfile],l:tlnr+l:y),"\"")
    " Let's append the next line: 
...
function! atplib#s:Search_Bib_Items(name)
	...
	if l:inputfile_dict[l:key][0] =~ '^\%(include\|input\|includeonly\)$'
	    call add(l:includefile_list,atplib#s:append(l:key,'.tex'))
	endif
    endfor
...
"     let b:ifl=l:includefile_list
	...
	let l:input_file = atplib#s:Read_Input_File(l:ifile,0)
...
function! atplib#s:showresults(bibresults,flags,pattern)
...
"     let b:kwflag_pattern=l:kwflag_pattern
	...
	for l:linenr in copy(sort(keys(a:bibresults[l:bibfile]),"atplib#s:comparelist"))
...
" 	    endfor
		...
		let l:ln+=1
 		let l:c0=atplib#s:count(l:values["bibfield_key"],'{')-atplib#s:count(l:values["bibfield_key"],'(')
...
" 			endif
		...
		let l:c1=atplib#s:count(l:lastline,'{')-atplib#s:count(l:lastline,'}')
		let l:c2=atplib#s:count(l:lastline,'(')-atplib#s:count(l:lastline,')')
		let l:c3=atplib#s:count(l:lastline,'\"')
...
" }}}1
" {{{1 s:count
function! atplib#s:count(line,keyword,...)
...
" }}}1
" {{{1 s:append 	/ at the end of a directory name
fun! atplib#s:append(where,what)
    return substitute(a:where,a:what . "\s*$",'','') . a:what
endfun
" }}}1
" {{{1 s:Find_Files 	/ find input files /
...
function! atplib#s:Find_files(dir,in_current_dir,ext)
	let l:raw_files=split(globpath(atplib#s:append(a:dir,'/'),'**'))
	if a:in_current_dir
...
function! atplib#s:Check_if_Closed(bpat,epat,line,limit,...)
...
" 	    endif
	" I assume that the env is opened in the line before!
	    let l:bpat_count+=atplib#s:count(l:line,a:bpat,1)
	    let l:epat_count+=atplib#s:count(l:line,a:epat,1)
...
" values.
function! atplib#s:Check_if_Opened(bpat,epat,line,limit,...)
...
" 		    echomsg " DEBUG CifO " . l:x
			...
			if substitute(l:line, a:bpat . '.\{-}' . a:epat,'','g')
			    ...
			    if !atplib#s:Check_if_Closed(a:bpat,a:epat,l:nr,a:limit,0)
			...
			if substitute(l:line, a:bpat . '.\{-}' . a:epat,'','g')
			    ...
			    let l:check=atplib#s:Check_if_Closed(a:bpat,a:epat,l:nr,a:limit,1)
...
" 		echomsg "co " . l:c . " lnr " . l:nr . " bpat " . l:bpat_count . " epat " . l:epat_count
		...
		let l:check=atplib#s:Check_if_Closed('\\begin{' . l:env_name . '}', '\\end{' . l:env_name . '}',1,a:limit,1)
...
" s:Copy_Indentation {{{1
function! atplib#s:Copy_Indentation(line)
...
"       My atplib#s:Check_if_Opened function is much faster !!!
	let l:begin_line_env 	= atplib#s:Check_if_Opened('\%(%.*\)\@<!\\begin\s*{',
		    \ '\%(%.*\)\@<!\\end\s*{',line("."),g:atp_completion_limits[2])
	let l:begin_line_dmath 	= atplib#s:Check_if_Opened(g:atp_math_modes[1][0],g:atp_math_modes[1][1],line("."),g:atp_completion_limits[1])
	let l:begin_line_imath 	= atplib#s:Check_if_Opened(g:atp_math_modes[0][0],g:atp_math_modes[0][1],line("."),g:atp_completion_limits[0])
    else
...
" 	let b:env=l:env " DEBUG
	...
	let l:eindent=atplib#s:Copy_Indentation(l:line)
...
" 		let b:cle_return="def"
		...
		\ !atplib#s:Check_if_Closed('\%(%.*\)\@<!\\begin\s*{' . l:env,'\%(%.*\)\@<!\\end\s*{' . l:env,line("."),g:atp_completion_limits[2])
		if l:com == 'a'  
	    ...
	    "}}}4
	    "{{{4
	    elseif l:close == 'displayed_math' && !atplib#s:Check_if_Closed(g:atp_math_modes[1][0],g:atp_math_modes[1][1],line("."),g:atp_completion_limits[1])
		if l:com == 'a' 
		    if getline(l:begin_line) =~ '^\s*\\\[\s*$'
			call append(line("."),atplib#s:Copy_Indentation(getline(l:begin_line)).'\]')
		    else
...
" 		    let b:cle_return="displayed math"
	    ...
	    "}}}4
	    "{{{4
	    elseif l:close == 'inline_math' && !atplib#s:Check_if_Closed(g:atp_math_modes[0][0],g:atp_math_modes[0][1],line("."),g:atp_completion_limits[1])
" 		exec "normal " . l:com  . "\\)"
		if l:com == 'a'
		    call setline(line("."), strpart(l:cline,0,getpos(".")[2]) . '\)'. strpart(l:cline,getpos(".")[2]))
		else
...
" 		echomsg "DEBUG ----------"
		...
		while l:line_nr >= 0
		    ...
		    let l:close_line_nr=atplib#s:Check_if_Closed('\%(%.*\)\@<!\\begin\s*{' . l:env_name, 
				\ '\%(%.*\)\@<!\\end\s*{' . l:env_name,
...
" 		let b:cenv_names=l:cenv_names
		for l:uenv in l:env_names
		    let l:uline_nr=atplib#s:Check_if_Closed('\%(%.*\)\@<!\\begin\s*{' . l:uenv . '}', 
...
" 		    let b:str=l:str " DEBUG
		    let l:eindent=atplib#s:Copy_Indentation(getline(l:line_nr))
		    let l:pos=getpos(".")
...
" 			call append(max(l:cenv_lines), l:eindent . l:str)
			...
			" a seprate line!
" 			let l:end=atplib#s:Check_if_Closed('\\begin\s*{','\\end\s*{',max(l:cenv_lines)+1,g:atp_completion_limits[2],1)
			let l:end=atplib#s:Check_if_Closed('\%(%.*\)\@<!\\begin\s*{','\%(%.*\)\@<!\\end\s*{',l:line_nr,g:atp_completion_limits[2],1)
...
"    let l:open_line=atplib#s:Check_if_Opened(
" 	       \ l:pattern_o, l:pattern_c,
" 	       \ line("."),g:atp_completion_limits[0],1)
"    let l:close_line=atplib#s:Check_if_Closed(
" 	       \ l:pattern_o, l:pattern_c,
" 	       \ line("."),g:atp_completion_limits[0],1)
...
"    endfor
   ...
   keepjumps call setpos(".",l:pos)
   let l:check_1= atplib#s:Check_if_Closed('\\\@<!(','\\\@<!)',line("."),g:atp_completion_limits[0],1) == '0'
   let l:pos[1]=l:pair_2[0]
   let l:pos[2]=l:pair_2[1]
   keepjumps call setpos(".",l:pos)
   let l:check_2= atplib#s:Check_if_Closed('\\{','\\}',line("."),g:atp_completion_limits[0],1) == '0'
   let l:pos[1]=l:pair_3[0]
   let l:pos[2]=l:pair_3[1]
   keepjumps call setpos(".",l:pos)
   let l:check_3= atplib#s:Check_if_Closed('\\\@<![','\\\@<!]',line("."),g:atp_completion_limits[0],1) == '0'
   let l:pos[1]=l:pair_4[0]
   let l:pos[2]=l:pair_4[1]
   keepjumps call setpos(".",l:pos)
   let l:check_4= atplib#s:Check_if_Closed('\\\@<!{','\\\@<!}',line("."),g:atp_completion_limits[0],1) == '0'
   keepjumps call setpos(".",l:pos_saved)
...
" 	let b:eline=l:eline
	...
	if l:line =~ escape(l:opening_size.l:opening_bracket,'\') . '\s*$' && col(".") == len(getline(line(".")))
	    let l:indent=s:Copy_Indentation(getline(l:open_line))
...
fun! atplib#s:compare_coordinates(listA,listB)
...
function! atplib#s:SearchPackage(name,...)
...
" {{{2 old function 
" function! atplib#s:Search_Package(name,...)
"     if a:0 == 0
" 	let l:command='usepackage\s*\%(\[[^]]*]\)\?'
"     elseif a:0 == 1
" 	let l:command=a:1
...
" }}}1
" s:Document_Class {{{1
function! atplib#s:Document_Class()
...
" }}}1
" {{{1 s:FindFiles 	/ find files: bst, cls, etc ... /
function! atplib#s:FindFiles(format,ext)
...
" are not present.
function! atplib#s:Extend(list_a,list_b,...)
...
" }}}1
" {{{1 s:Add_to_List
function! atplib#s:Add_to_List(list,what)
    let l:new=[] 
    for l:el in a:list
...
"
function! atplib#Tab_Completion(expert_mode,...)
...
" 	let b:comp_method="bracket"
" " 	let l:completion_method="bracket"
" 	let b:tc_return="bracket"
" 	return ''
"     endif
" }}}2
...
" 	    let b:comp_method='command fast return'
	...
	if index(g:atp_completion_active_modes, 'environment names') != -1 
	    ...
	    "DEBUG:
" 	    let b:comp_method='begin'
	else
" 	    let b:comp_method='begin fast return'
	    return ''
	endif
    "}}}3
...
" 	    let b:comp_method='bibitems fast return'
	...
	\ !atplib#s:compare_coordinates(searchpos('[^%]*\zs\\tikz{','bnw'),searchpos('}','bnw'))
"     elseif search('\\begin{tikzpicture}','bnW') > search('\\end{tikzpicture}','bnW') ||
" 		\ !atplib#s:compare_coordinates(searchpos('\\tikz{','bnW'),searchpos('}','bnW'))
...
" {{{2 close environments
	...
	let l:env_opened = atplib#s:Check_if_Opened(
		    \ '\%(%.*\)\@<!\\begin\s*{\%(document\)\@!',
		    \ '\%(%.*\)\@<!\\end\s*{\%(document\)\@!',
		    \ line('.'),g:atp_completion_limits[2],2)
    "     let l:env_opened = atplib#s:Check_if_Opened('\%(%.*\)\@<!\\begin\s*{\%(document\)\@!','\%(%.*\)\@<!\\end\s*{\%(document\)\@!',
    " 				\ line('.'),g:atp_completion_limits[2],2)
    "     let l:env_opened = min([atplib#s:Check_if_Opened('\%(%.*\)\@<!\\begin{\%(document\)\@!','\%(%.*\)\@<!\\end{\%(document\)\@!',
    " 				\ line('.'),g:atp_completion_limits[2],1),
    " 				\ atplib#s:Check_if_Opened('\%(%.*\)\@<!\\begin{\%(document\)\@!','\%(%.*\)\@<!\\end{\%(document\)\@!',
    " 				\ line('.'),g:atp_completion_limits[2],2)])
" 	let b:env_opened = l:env_opened
    ...
    " 	let b:env_name=l:env_name " DEBUG
	    let l:env_closed 	= atplib#s:Check_if_Closed('\%(%.*\)\@<!\\begin{' . l:env_name,'\%(%.*\)\@<!\\end{' . l:env_name,
				    \ line('.'),g:atp_completion_limits[2],1)
	else
	    let l:env_closed=1
	    let l:env_name=0 	" this is compatible with atplib#CloseLastEnvironment() function (argument for a:3).
	endif
	let l:imath_closed	= atplib#s:Check_if_Closed(g:atp_math_modes[0][0],g:atp_math_modes[0][1],line('.'),g:atp_completion_limits[0])
	let l:imath_opened	= atplib#s:Check_if_Opened(g:atp_math_modes[0][0],g:atp_math_modes[0][1],line('.'),g:atp_completion_limits[0])
	let l:dmath_closed	= atplib#s:Check_if_Closed(g:atp_math_modes[1][0],g:atp_math_modes[1][1],line('.'),g:atp_completion_limits[1])
	let l:dmath_opened	= atplib#s:Check_if_Opened(g:atp_math_modes[1][0],g:atp_math_modes[1][1],line('.'),g:atp_completion_limits[1])
    " DEBUG:
...
" 	 if !atplib#s:Check_if_Closed('\\\[','\\\]',line('.'),g:atp_completion_limits[1]) && !atplib#s:Check_if_Closed('\\(','\\)',line('.'),g:atp_completion_limits[1])
" " 	 if !l:env_closed && !
" 	     let l:completion_method='close_env'
...
"		this doesn't work because atplib#s:Check_if_Opened is not
...
" {{{2 SET COMPLETION LIST
	...
	if l:end !~ '\s*}'
		...
		let l:completion_list=atplib#s:Extend(l:completion_list,s:atp_local_environments)
	    endif
	    let l:completion_list=atplib#s:Add_to_List(l:completion_list,'}')
	else
	    let l:completion_list=deepcopy(g:atp_environments)
	    if b:atp_local_completion_lists
		" Make a list of local envs and commands
		...
		call atplib#s:Extend(l:completion_list, s:atp_local_environments)
	    endif
	endif
	" TIKZ
	keepjumps call setpos(".",[0,1,1,0])
	...
	keepjumps call setpos(".",l:pos)
	if atplib#s:SearchPackage('tikz',l:stop_line) && 
		    \ ( !g:atp_check_if_opened || 
		    \ atplib#s:Check_if_Opened('\\begin\s*{tikzpicture}','\\end\s*{tikzpicture}',line('.'),80) || 
		    \ atplib#s:Check_if_Opened('\\tikz{','}',line("."),g:atp_completion_limits[2]) )
	    if l:end !~ '\s*}'
		call extend(l:completion_list,atplib#s:Add_to_List(g:atp_tikz_environments,'}'))
	    else
		call extend(l:completion_list,g:atp_tikz_environments)
	    endif
	endif
	" AMSMATH
	if atplib#s:SearchPackage('amsmath',l:stop_line) || g:atp_amsmath == 1 || atplib#s:Document_Class() =~ '^ams'
	    if l:end !~ '\s*}'
		call extend(l:completion_list,atplib#s:Add_to_List(g:atp_amsmath_environments,'}'),0)
	    else
	...
	" check them.
	if atplib#s:SearchPackage('.*arrows',l:stop_line,'usetikzlibrary')
	    call extend(l:completion_list,g:atp_tikz_library_arrows_keywords)
	endif   
	if atplib#s:SearchPackage('.*automata',l:stop_line,'usetikzlibrary')
	    call extend(l:completion_list,g:atp_tikz_library_automata_keywords)
	endif   
	if atplib#s:SearchPackage('.*background',l:stop_line,'usetikzlibrary')
	    call extend(l:completion_list,g:atp_tikz_library_backgrounds_keywords)
	endif   
	if atplib#s:SearchPackage('.*calendar',l:stop_line,'usetikzlibrary')
	    call extend(l:completion_list,g:atp_tikz_library_calendar_keywords)
	endif
	if atplib#s:SearchPackage('.*chain',l:stop_line,'usetikzlibrary')
	    call extend(l:completion_list,g:atp_tikz_library_chain_keywords)
	endif
	if atplib#s:SearchPackage('.*decorations',l:stop_line,'usetikzlibrary')
	    call extend(l:completion_list,g:atp_tikz_library_decoration_keywords)
	endif
	if atplib#s:SearchPackage('.*matrix',l:stop_line,'usetikzlibrary')
...
" 	call extend(l:completion_list,g:atp_math_commands)
	...
	let l:completion_list=[]
		...
		if g:atp_math_opened
			...
			if atplib#s:Check_if_Opened(l:key[0],l:key[1],line("."),g:atp_completion_limits[2])
...
"
		    ...
		    if g:atp_amsmath == 1 || atplib#s:SearchPackage('amsmath',l:stop_line) || 
				\ atplib#s:SearchPackage('amssymb',l:stop_line) || atplib#s:Document_Class() =~ '^ams'
			if a:expert_mode == 0
		    ...
		    if atplib#s:SearchPackage('amssymb',l:stop_line)
		    ...
		    " TIKZ 
		    if atplib#s:SearchPackage('tikz',l:stop_line)
" 			if search('\%(\\def\>.*\|\\\%(re\)\?newcommand\>.*\|%.*\)\@<!\\begin{tikzpicture}','bnW') > search('[^%]*\\end{tikzpicture}','bnW') ||
" 				    \ !atplib#s:compare_coordinates(searchpos('[^%]*\zs\\tikz{','bnW'),searchpos('}','bnW'))
			...
			if search('\\begin{tikzpicture}','bnW') > search('\\end{tikzpicture}','bnW') ||
			    ...
			    if atplib#s:SearchPackage('.*chain','usetikzlibrary')
				call extend(l:completion_list,g:atp_tikz_library_chain)
			    endif
			endif
		    endif
		    " NICEFRAC
		    if atplib#s:SearchPackage('nicefrac',l:stop_line)
			call add(l:completion_list,'nicefrac')
		    endif
		    " FANCYHDR
		    if atplib#s:SearchPackage('fancyhdr',l:stop_line)
...
" 	let b:no_sep=l:no_separator " DEBUG
	...
	let l:completion_list=[]
	let l:completion_list=deepcopy(values(atplib#s:generatelabels(fnamemodify(bufname("%"),":p"))[fnamemodify(bufname("%"),":p")]))
	if l:nchar != '}'
	...
	let l:inputfiles=atplib#s:Find_files(g:texmf,1,".tex")
	let l:completion_list=[]
	...
	for l:dir in g:atp_bibinputs
	    let l:bibfiles=extend(l:bibfiles,atplib#s:Find_files(l:dir,0,".bib"))
	endfor
	let l:completion_list=[]
	...
	let l:completion_list=atplib#s:FindFiles("bst","bst")
    "}}}3
    "{{{3 ------------ DOCUMENTCLASS
    elseif l:completion_method == 'documentclass'
	let l:completion_list=atplib#s:FindFiles("tex","cls")
	if l:nchar != "}"
	    call map(l:completion_list,'v:val."}"')
	endif
    " }}}3
	...
	let l:bibitems_list=values(atplib#s:searchbib(l:begin))
" 	let b:bibitems_list=deepcopy(l:bibitems_list)
	...
	call extend(l:completion_list,keys(atplib#s:Search_Bib_Items(b:atp_mainfile)))
    endif
    " }}}3
...
" 			    && l:item =~ '\C^\\' . l:tbegin && l:item =~ '.*{[}\s]*$'
			    let l:completions=filter(l:completion_list,'v:val =~ "\\C^\\\\".l:tbegin')
...
" 	let b:tc_return="tikzpicture keywords"
	...
	\ !atplib#s:Check_if_Closed(g:atp_math_modes[0][0],g:atp_math_modes[0][1],line("."),g:atp_completion_limits[0])

	" DEBUG:
" 	let b:dmc=atplib#s:Check_if_Closed(g:atp_math_modes[1][0],g:atp_math_modes[1][1],line('.'),g:atp_completion_limits[1])
" 	let b:dmo=atplib#s:Check_if_Opened(g:atp_math_modes[1][0],g:atp_math_modes[1][1],line('.'),g:atp_completion_limits[1])

	if !atplib#s:Check_if_Closed(g:atp_math_modes[1][0],g:atp_math_modes[1][1],line('.'),g:atp_completion_limits[1]) && atplib#s:Check_if_Opened(g:atp_math_modes[1][0],g:atp_math_modes[1][1],line('.'),g:atp_completion_limits[1])
	    call atplib#CloseLastEnvironment('i','displayed_math')
	elseif !atplib#s:Check_if_Closed(g:atp_math_modes[0][0],g:atp_math_modes[0][1],line('.'),g:atp_completion_limits[0]) && atplib#s:Check_if_Opened(g:atp_math_modes[0][0],g:atp_math_modes[0][1],line('.'),g:atp_completion_limits[1])
	    call atplib#CloseLastEnvironment('i','inline_math')
	elseif !atplib#s:Check_if_Closed('\\begin\s*{','\\end\*{',line("."),g:atp_completion_limits[2]) &&
		    \ atplib#s:Check_if_Opened('\\begin\s*{','\\end\*{',line("."),g:atp_completion_limits[2])
	    call atplib#CloseLastEnvironment('a','environment')
	endif
